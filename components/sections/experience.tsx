  ...
  return (
    <section id="experience" className="border-b border-[var(--border)]">
      <div className="mx-auto w-full max-w-6xl px-6 py-20 sm:px-8 lg:px-10 lg:py-24">
        ...
        {/* ── Desktop layout ── */}
        <div className="mt-12 hidden flex-col gap-8 md:flex">
          {experience.map((entry, index) => {
            ...
            return (
              <ScrollReveal
                ...
                delay={index * 110}
              >
                <div className="grid grid-cols-[320px_minmax(320px,1fr)] items-stretch gap-5">
                  {/* Image Card */}
                  ...
                  <div className="min-w-[320px] rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-7 shadow-sm transition-all duration-300 hover:border-[var(--accent)]/30 hover:shadow-md">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
                        <h3 className="text-xl leading-snug font-semibold text-[var(--text-primary)]">
                          {entry.role}
                        </h3>
                      ...
                      <div className="flex shrink-0 flex-col items-end gap-1.5">
                        ...
                        {entry.type && (
                          <span className="font-ui-mono inline-flex rounded-md border border-[var(--border)] bg-[var(--background)] px-2 py-0.5 text-[11px] text-[var(--text-muted)]">
                            {entry.type}
                          </span>
                        )}
                      </div>
                    ...
                    {entry.stack.length > 0 && (
                      <div className="mt-5">
                        <p className="font-ui-mono mb-2.5 text-[10px] tracking-[0.2em] text-[var(--accent)] uppercase">
                          Tech Stack
                        </p>
                ...
                <div className="overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--surface)] shadow-sm">
                  ...
                  <div className="px-4 pt-3.5 pb-4">
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <h3 className="text-base leading-snug font-semibold text-[var(--text-primary)]">
                        {entry.role}, {entry.company}
                      </h3>
                      <span className="font-ui-mono mt-0.5 shrink-0 text-[11px] text-[var(--text-muted)]">
                        {periodLabel}
                      </span>
                    </div>
                    ...
                    {entry.stack.length > 0 && (
                      <div className="mt-3">
                        <p className="font-ui-mono mb-1.5 text-[10px] tracking-widest text-[var(--text-muted)] uppercase">
                          Tech Stack:
                        </p>
                        <div className="flex flex-wrap gap-1">
                          {entry.stack.map((item) => (
                            <Tag key={item} className="px-2 py-0.5 text-[11px]">
                              {item}
                            </Tag>
                          ))}
                        </div>
